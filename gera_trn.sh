...
echo "tstFinal ... ok"
python ~/Documentos/projeto/libsvm-3.17/tools/grid.py ~/workspaceC++/_libSVM_/testeImgProcess4/trnFinal.libsvm > ~/workspaceC++/_libSVM_/testeImgProcess4/grid_py_arquivoGeral
echo "grid.py ... ok"
